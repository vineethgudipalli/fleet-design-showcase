...
const Heart3D = ({ className }: { className?: string }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none">
        ...
        <path
            ...
            strokeWidth="0.5"
        />
        <path d="M8.5 6.5c1.5-1.5 3.5-1 4.5 0l-1 1c-0.5-0.5-1.5-0.8-2.5 0.2z" fill="url(#heartShine)" />
    </svg>
);
...
const ThumbsUp3D = ({ className }: { className?: string }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none">
        ...
        />
        {/* Four fingers folded */}
        <path d="M6 12c-1.1 0-2 .9-2 2v4c0 1.1.9 2 2 2h2V12H6z" fill="url(#thumbGradient)" stroke="#1565c0" strokeWidth="0.5" />
        {/* White shirt cuff */}
        <rect x="5" y="19" width="8" height="3" rx="1.5" fill="url(#cuffGradient)" stroke="#dee2e6" strokeWidth="0.5" />
        {/* Shine on thumb */}
        <ellipse cx="9.5" cy="5" rx="0.8" ry="1.5" fill="url(#thumbShine)" />
    </svg>
);
...
const Lightbulb3D = ({ className }: { className?: string }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none">
        ...
        />
        {/* Base */}
        <rect x="9" y="17" width="6" height="2" rx="0.5" fill="url(#baseGradient)" stroke="#d84315" strokeWidth="0.5" />
        {/* Shine */}
        <ellipse cx="10.5" cy="7" rx="1.5" ry="2" fill="rgba(255, 255, 255, 0.4)" />
    </svg>
);
...
export default function PrototypeReactions({ reactions, onReact, className = "", size = "sm" }: PrototypeReactionsProps) {
